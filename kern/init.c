...
i386_init(void)
{
	...
	//LAB4 challenge test priority
	/*
	ENV_CREATE(user_test_p3, ENV_TYPE_USER);
	ENV_CREATE(user_test_p2, ENV_TYPE_USER);
	ENV_CREATE(user_test_p1, ENV_TYPE_USER);
	ENV_CREATE(user_test_p0, ENV_TYPE_USER);
	*/
#endif // TEST*
